...
$prompt-color:          $gray;
//全局不同状态颜色
$active-color-base:  unquote("rgb(#{$palette-indigo-700})") !default;
$normal-color-base:  unquote("rgb(#{$palette-indigo-500})") !default;
$hover-color-base:   unquote("rgb(#{$palette-indigo-500})") !default;
...
$brand-primary : unquote("rgb(#{$palette-indigo-500})") !default;
$brand-primary-hover: unquote("rgb(#{$palette-indigo-400})") !default;
$brand-primary-active: unquote("rgb(#{$palette-indigo-600})") !default;

$brand-success: unquote("rgb(#{$palette-green-500})") !default;
$brand-success-hover: unquote("rgb(#{$palette-green-400})") !default;
$brand-success-active: unquote("rgb(#{$palette-green-600})") !default;

$brand-info: unquote("rgb(#{$palette-cyan-500})") !default;
$brand-info-hover: unquote("rgb(#{$palette-cyan-400})") !default;
$brand-info-active: unquote("rgb(#{$palette-cyan-600})") !default;
...
$button-min-width: 72/16 * $unit !default;
$button-height: 36/16 * $unit !default;
$button-padding: 5/16* $unit  13/16 * $unit !default;
$button-padding-IE8: 5px 13px !default;
$button-top-padding: 13/16 * $unit !default;
$button-left-padding: 6/16* $unit !default;
$button-line-height:1.57142857;
$button-margin: 4/16 * $unit !default;
$button-border-radius: 4/16 * $unit !default;

$button-fab-size: 38/16 * $unit !default;
$button-fab-size-mini: 30/16 * $unit !default;
$button-fab-font-size: 14/16 * $unit !default;

$button-icon-size: 32/16 * $unit !default;
$button-icon-size-mini: 13/16 * $unit !default;

$button-raised-font-size: 14/16 * $unit !default;
