...
.u-button-accent{
    @include button-styles-variant($button-fab-text-color-alt,$button-fab-color-alt,$button-fab-hover-color-alt,$button-fab-active-color-alt);
}
.u-button-primary{
    @include button-styles-variant($button-secondary-color-alt,$button-primary-color-alt,$button-primary-hover-color-alt,$button-primary-active-color);
}
.u-button-danger{
    @include button-styles-variant($button-secondary-color-alt,$button-danger-color,$button-danger-hover-color,$button-danger-active-color);
}
.u-button-info{
    @include button-styles-variant($button-secondary-color-alt,$button-info-color,$button-info-hover-color,$button-info-active-color);
}
.u-button-warning{
    @include button-styles-variant($button-secondary-color-alt,$button-warning-color,$button-warning-hover-color,$button-warning-active-color);
}
.u-button-success{
    @include button-styles-variant($button-secondary-color-alt,$button-success-color,$button-success-hover-color,$button-success-active-color);
}
.u-button-border.u-button-accent{
    @include border-button-styles-variant($button-fab-color-alt,$button-fab-color-alt,$button-fab-color-alt,$button-fab-active-color-alt);
}
